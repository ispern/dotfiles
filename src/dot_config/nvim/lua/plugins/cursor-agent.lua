...
return {
	{
		...
		keys = {
			{ "<leader>au", nil, desc = "AI/Cursor CLI" },
			{ "<leader>auc", "<cmd>CursorAgent<cr>", desc = "Cursor Agent: Toggle terminal" },
			{ "<leader>aub", "<cmd>CursorAgentBuffer<cr>", desc = "Cursor Agent: Send buffer" },
			{ "<leader>aul", "<cmd>CursorAgentSelection<cr>", desc = "Cursor Agent: Send selection", mode = "v" },
		},
		config = function()
